...
def visualize(sequence_pyramid): #调用函数1
...
def cv_show(image, message="crane"): #调用函数2
...
def exposure_fusion(sequence, alphas=(1.0, 1.0, 1.0), best_illumination=0.5, sigma=0.2, eps=1e-12,use_1=False, #调用函数3
